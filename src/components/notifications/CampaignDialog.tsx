          ...
          {title && (
            <div className="rounded-xl border bg-muted/50 p-3 space-y-2">
              ...
              <div className="rounded-lg bg-background border p-3 space-y-1 shadow-sm max-w-xs">
                <div className="flex items-center gap-2">
                  <div className="h-5 w-5 rounded bg-primary/20 flex items-center justify-center text-[10px] font-bold text-primary">L</div>
                  <span className="text-[11px] text-muted-foreground">LNDRY</span>
