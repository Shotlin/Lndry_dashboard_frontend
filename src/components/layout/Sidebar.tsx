...
const NAV_SECTIONS: Array<{ section: string; items: NavItem[] }> = [
  {
    ...
    items: [
      ...
      { id: "reconciliationProblemTypes", label: "Re-evaluation Problems", href: "/reconciliation-problem-types", icon: "FileWarning" },
      { id: "referralPrograms", label: "Referral Programs", href: "/referral-programs", icon: "UserPlus" },
      { id: "referrals", label: "Referrals", href: "/referrals", icon: "Share2" },
