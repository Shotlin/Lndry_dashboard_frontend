...
export const ROUTE_GUARDS: RouteGuard[] = [
  ...
  { pattern: /^\/reconciliation-problem-types$/, anyOf: ["settings.write"] },
  { pattern: /^\/help-faqs$/, anyOf: ["settings.write"] },
  { pattern: /^\/account-deletion-requests$/, anyOf: ["customers.write"] },
  ...
  { pattern: /^\/settings\/platform$/, anyOf: ["settings.write"] },
  { pattern: /^\/settings\/rider-assignment$/, anyOf: ["settings.write"] },
...
export const MENU_PERMISSIONS: Record<string, MenuPermission> = {
  ...
  reconciliationProblemTypes: { key: "reconciliationProblemTypes", anyOf: ["settings.write"] },
  helpFaqs: { key: "helpFaqs", anyOf: ["settings.write"] },
  accountDeletionRequests: { key: "accountDeletionRequests", anyOf: ["customers.write"] },
  referralPrograms: { key: "referralPrograms", anyOf: ["settings.write"] },
  referrals: { key: "referrals", anyOf: ["settings.write"] },
  fees: { key: "fees", anyOf: ["settings.write"] },
  riderAssignment: { key: "riderAssignment", anyOf: ["settings.write"] },
