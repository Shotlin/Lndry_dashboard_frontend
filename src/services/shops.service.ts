...
import type { ApiResponse, ListParams, Paginated, Shop, ShopInput } from "@/types"

/**
 * Query params accepted by `GET /api/v1/shops`.
 *
 * Mirrors `listShopsQuerySchema` on the backend
 * (`LNDRY-backend/src/modules/shops/shops.schema.js`). Booleans are
...
export const shopsService = {
   ...
   * `LNDRY-backend/src/modules/shops/shops.routes.js`. The body is a
