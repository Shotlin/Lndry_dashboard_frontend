  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Spend-ladder rewards that apply to every qualifying order, not just a customer's first"
      >
        {canManage && (
              ...
              <TableRow>
                <TableCell colSpan={7}>
                  <EmptyState
                    ...
                    description="Create a spend-ladder reward like &quot;Spend ₹500, get ₹50 off&quot;"
                  />
                </TableCell>
              </TableRow>
            ) : (
