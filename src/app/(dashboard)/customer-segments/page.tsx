...
function CustomerSegmentsContent() {
  ...
  const handleDelete = (segment: CustomerSegment) => {
    if (confirm(`Delete segment "${segment.name}"? This removes it from any coupons using it.`)) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Group customers to target with coupons"
      >
        {canManage && (
              ...
              <TableRow>
                <TableCell colSpan={6}>
                  <EmptyState
                    ...
                    description='Create a segment like "Repeat Weekly Customers" to target with coupons'
                  />
                </TableCell>
              </TableRow>
            ) : (
